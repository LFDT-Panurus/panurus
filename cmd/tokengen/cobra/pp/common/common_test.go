...
func TestLoadExtras(t *testing.T) {
	...
	for _, tc := range []struct {
		name string
		fn   func(t *testing.T, tempDir string)
	}{
		{"success_multiple_files", testLoadExtrasSuccessMultipleFiles},
		{"empty_input", testLoadExtrasEmptyInput},
		{"file_not_found", testLoadExtrasFileNotFound},
		{"invalid_format_no_colon", testLoadExtrasInvalidFormatNoColon},
		{"invalid_format_empty_key", testLoadExtrasInvalidFormatEmptyKey},
		{"invalid_format_empty_filepath", testLoadExtrasInvalidFormatEmptyFilepath},
		{"filepath_with_colons", testLoadExtrasFilepathWithColons},
		{"binary_content", testLoadExtrasBinaryContent},
	} {
...
// testLoadExtrasSuccessMultipleFiles covers successfully loading multiple files.
func testLoadExtrasSuccessMultipleFiles(t *testing.T, tempDir string) {
	t.Helper()
...
// testLoadExtrasEmptyInput covers an empty input slice.
func testLoadExtrasEmptyInput(t *testing.T, _ string) {
	t.Helper()
	extraFiles := []string{}
...
// testLoadExtrasFileNotFound covers a file that does not exist.
func testLoadExtrasFileNotFound(t *testing.T, tempDir string) {
	t.Helper()
	extraFiles := []string{
...
// testLoadExtrasInvalidFormatNoColon covers an invalid format with no colon.
func testLoadExtrasInvalidFormatNoColon(t *testing.T, _ string) {
	t.Helper()
...
// testLoadExtrasInvalidFormatEmptyKey covers an invalid format with an empty key.
func testLoadExtrasInvalidFormatEmptyKey(t *testing.T, tempDir string) {
	t.Helper()
...
// testLoadExtrasInvalidFormatEmptyFilepath covers an invalid format with an empty filepath.
func testLoadExtrasInvalidFormatEmptyFilepath(t *testing.T, _ string) {
	t.Helper()
...
// testLoadExtrasFilepathWithColons covers a filepath that might have colons (e.g. Windows paths or URLs).
func testLoadExtrasFilepathWithColons(t *testing.T, tempDir string) {
	t.Helper()
...
// testLoadExtrasBinaryContent covers binary file content.
func testLoadExtrasBinaryContent(t *testing.T, tempDir string) {
	t.Helper()
