...
func (t TransactionRecord) String() string {
	...
	_, _ = s.WriteString("{")
	_, _ = s.WriteString(t.TxID)
	_, _ = s.WriteString(" ")
	_, _ = s.WriteString(strconv.Itoa(int(t.ActionType)))
	_, _ = s.WriteString(" ")
	_, _ = s.WriteString(t.SenderEID)
	_, _ = s.WriteString(" ")
	_, _ = s.WriteString(t.RecipientEID)
	_, _ = s.WriteString(" ")
	_, _ = s.WriteString(string(t.TokenType))
	_, _ = s.WriteString(" ")
	_, _ = s.WriteString(t.Amount.String())
	_, _ = s.WriteString(" ")
	_, _ = s.WriteString(t.Timestamp.String())
	_, _ = s.WriteString(" ")
	_, _ = s.WriteString(TxStatusMessage[t.Status])
	_, _ = s.WriteString("}")
