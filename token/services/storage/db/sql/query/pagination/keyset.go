...
// pageSize implements pageSized so ValidateLimited can bound every keyset the
// same way it bounds an offset page.
func (p *keyset[I]) pageSize() int { return p.PageSize }
