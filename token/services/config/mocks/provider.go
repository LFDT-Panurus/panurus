...
func (fake *Provider) UnmarshalKey(arg1 string, arg2 any) error {
...
func (fake *Provider) UnmarshalKeyCalls(stub func(string, any) error) {
	fake.unmarshalKeyMutex.Lock()
	defer fake.unmarshalKeyMutex.Unlock()
	fake.UnmarshalKeyStub = stub
}

func (fake *Provider) UnmarshalKeyArgsForCall(i int) (string, any) {
	fake.unmarshalKeyMutex.RLock()
	defer fake.unmarshalKeyMutex.RUnlock()
